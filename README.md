...
- 🌿 **Created branch** `fix/src/the-move-discovery-links` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `20 Sep 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Bring The Move Artist page in line with the current Artist-page standard_ `20 Sep 2026`

<sub>Last updated: 20 September 2026 at 14:10 UTC</sub>
<!-- ACTIVITY_END -->
