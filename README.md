...
- 🔨 **Pushed** to [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `5 Jun 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Refine Homepage Hero Banner Styling Following Blowfish Migration_ `5 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Investigate Automating Lighthouse Manual SEO Checks in CI/CD_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Template Version Is Not Bumped When Template Is Updated_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Conduct Full Repository Issue Triage and Backlog Rationalisation_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Streamline SEO Agent Instructions to Reduce Copilot Token Usage_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Investigate Automating Lighthouse SEO Manual Checks in CI/CD_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Add Dev Container Configuration to Improve Contributor Onboarding_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Add “Open in Codespaces” Button to Improve Contributor Onboarding_ `4 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _[bug] Bump template version workflow fails to push to protected main bra_ `4 Jun 2026`

<sub>Last updated: 5 June 2026 at 09:13 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**alire-project/alire**](https://github.com/alire-project/alire) — Command-line tool from the Alire project and supporting library  `Ada` ⭐ 394
- [**mrshu/github-statuses**](https://github.com/mrshu/github-statuses) — The "Missing GitHub Status Page" -- a Flat Data attempt at historically document  `HTML` ⭐ 463
...
- [**dotnet/skills**](https://github.com/dotnet/skills) — Repository for skills to assist AI coding agents with .NET and C#  `C#` ⭐ 3,270
- [**AzuraCast/AzuraCast**](https://github.com/AzuraCast/AzuraCast) — A self-hosted web radio management suite, including turnkey installer tools for   `PHP` ⭐ 3,885
- [**Radiergummi/tspages**](https://github.com/Radiergummi/tspages) — A lightweight static site hosting platform for your Tailscale network.  `Go` ⭐ 27
