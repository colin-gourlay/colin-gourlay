...
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Fix specific issue identified in Lighthouse report_ `8 May 2026`
- 🔨 **Pushed** to [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `7 May 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Update the upcoming show to a date in the future_ `7 May 2026`
- 🐛 **Opened issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Update the upcoming show to a date in the future_ `7 May 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Refine workflow in the Azure Function_ `7 May 2026`
- 🐛 **Opened issue** in [`colin-gourlay/east-coast-fm-website`](https://github.com/colin-gourlay/east-coast-fm-website) — _Obtain Live Streaming Feed and Add to “Listen Live” Links_ `7 May 2026`
- 🐛 **Opened issue** in [`colin-gourlay/east-coast-fm-website`](https://github.com/colin-gourlay/east-coast-fm-website) — _Determine Correct Apple App Store Link and Replace Placeholder URLs_ `7 May 2026`
...
<sub>Last updated: 8 May 2026 at 05:04 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**home-assistant/core**](https://github.com/home-assistant/core) — :house_with_garden: Open source home automation that puts local control and priv  `Python` ⭐ 86,951
- [**curl/curl**](https://github.com/curl/curl) — A command line tool and library for transferring data with URL syntax, supportin  `C` ⭐ 41,744
