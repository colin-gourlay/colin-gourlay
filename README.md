...
- 🌿 **Created branch** `docs/20260602-seo-agent-indexing-directives` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `2 Jun 2026`
- 🌿 **Created branch** `fix/20260602-improve-watch-level-task-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `2 Jun 2026`
- 🌿 **Created branch** `chore/20260602-improve-health-task-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `2 Jun 2026`
- 🐛 **Closed issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Remove the hyperlink from the featured template_ `2 Jun 2026`
- 🌿 **Created branch** `chore/20260602-improve-template-description` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `2 Jun 2026`
- 🐛 **Opened issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Remove the hyperlink from the featured template_ `2 Jun 2026`

<sub>Last updated: 2 June 2026 at 09:32 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**dotnet/skills**](https://github.com/dotnet/skills) — Repository for skills to assist AI coding agents with .NET and C#  `C#` ⭐ 3,232
