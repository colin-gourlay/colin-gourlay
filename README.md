...
- 🌿 **Created branch** `improve-release-hero-artwork` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `26 Jun 2026`
- 🌿 **Created branch** `feat/issue-46-for-sale-playlist-cue` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `26 Jun 2026`
...
<sub>Last updated: 27 June 2026 at 07:10 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**obsproject/obs-studio**](https://github.com/obsproject/obs-studio) — OBS Studio - Free and open source software for live streaming and screen recordi  `C` ⭐ 73,475
- [**music-assistant/server**](https://github.com/music-assistant/server) — Music Assistant is a free, opensource Media library manager that connects to you  `Python` ⭐ 2,766
- [**iptv-org/iptv**](https://github.com/iptv-org/iptv) — Collection of publicly available IPTV channels from all over the world  `TypeScript` ⭐ 128,731
- [**microsoft/autogen**](https://github.com/microsoft/autogen) — A programming framework for agentic AI  `Python` ⭐ 59,286
- [**refactoringhq/tolaria**](https://github.com/refactoringhq/tolaria) — Desktop app to manage markdown knowledge bases  `TypeScript` ⭐ 16,986
- [**mixxxdj/mixxx**](https://github.com/mixxxdj/mixxx) — Mixxx is Free DJ software that gives you everything you need to perform live mix  `C++` ⭐ 6,862
