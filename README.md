...
<sub>Last updated: 19 April 2026 at 08:24 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**snarktank/ralph**](https://github.com/snarktank/ralph) — Ralph is an autonomous AI agent loop that runs repeatedly until all PRD items ar  `TypeScript` ⭐ 17,295
- [**ChromeDevTools/chrome-devtools-mcp**](https://github.com/ChromeDevTools/chrome-devtools-mcp) — Chrome DevTools for coding agents  `TypeScript` ⭐ 36,120
- [**Tracer-Cloud/opensre**](https://github.com/Tracer-Cloud/opensre) — Build your own AI SRE agents. The open source toolkit for the AI era ✨  `Python` ⭐ 1,721
- [**lukilabs/craft-agents-oss**](https://github.com/lukilabs/craft-agents-oss)  `TypeScript` ⭐ 4,383
- [**BasedHardware/omi**](https://github.com/BasedHardware/omi) — AI that sees your screen, listens to your conversations and tells you what to do  `Dart` ⭐ 10,652
- [**EvoMap/evolver**](https://github.com/EvoMap/evolver) — The GEP-Powered Self-Evolution Engine for AI Agents. Genome Evolution Protocol.   `JavaScript` ⭐ 5,177
