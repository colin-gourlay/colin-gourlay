...
- 🌿 **Created branch** `fix/20260604-improve-wiki-problem-statement-task` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `4 Jun 2026`
- 🔀 **Opened PR** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — __ `4 Jun 2026`
- 🌿 **Created branch** `fix/20260604-improve-roadmap-task-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `4 Jun 2026`
- 🌿 **Created branch** `docs/20260604-changelog-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `4 Jun 2026`
- 🐛 **Closed issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Published Template Versions in `meta.yml` Are Out of Sync with Deployed _ `4 Jun 2026`
- 🌿 **Created branch** `docs/20260604-improve-readme-setup-task-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `4 Jun 2026`
- 🌿 **Created branch** `chore/20260604-improve-architecture-task-copy` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `4 Jun 2026`
...
- 🐛 **Closed issue** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — _Confusing numbering in the featured template_ `4 Jun 2026`

<sub>Last updated: 4 June 2026 at 17:06 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**dotnet/skills**](https://github.com/dotnet/skills) — Repository for skills to assist AI coding agents with .NET and C#  `C#` ⭐ 3,266
