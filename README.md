...
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Refine Hero Section Text Positioning for Improved Visual Hierarchy_ `25 Jun 2026`
- 🌿 **Created branch** `feat/src/release-taxonomies` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `25 Jun 2026`
- 🌿 **Created branch** `release-discover-more` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `25 Jun 2026`
- 🌿 **Created branch** `feat/src/add-release-explore-further` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `25 Jun 2026`
- 🌿 **Created branch** `feat/src/add-release-artists-section` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `25 Jun 2026`

<sub>Last updated: 25 June 2026 at 18:49 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**obsproject/obs-studio**](https://github.com/obsproject/obs-studio) — OBS Studio - Free and open source software for live streaming and screen recordi  `C` ⭐ 73,434
...
- [**iptv-org/iptv**](https://github.com/iptv-org/iptv) — Collection of publicly available IPTV channels from all over the world  `TypeScript` ⭐ 128,472
- [**microsoft/autogen**](https://github.com/microsoft/autogen) — A programming framework for agentic AI  `Python` ⭐ 59,249
- [**refactoringhq/tolaria**](https://github.com/refactoringhq/tolaria) — Desktop app to manage markdown knowledge bases  `TypeScript` ⭐ 16,933
