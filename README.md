...
<sub>Last updated: 7 June 2026 at 22:26 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**alire-project/alire**](https://github.com/alire-project/alire) — Command-line tool from the Alire project and supporting library  `Ada` ⭐ 395
...
- [**dotnet/skills**](https://github.com/dotnet/skills) — Repository for skills to assist AI coding agents with .NET and C#  `C#` ⭐ 3,294
