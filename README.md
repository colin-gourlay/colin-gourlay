...
<sub>Last updated: 8 July 2026 at 14:49 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**iptv-org/iptv**](https://github.com/iptv-org/iptv) — Collection of publicly available IPTV channels from all over the world  `TypeScript` ⭐ 131,125
- [**microsoft/autogen**](https://github.com/microsoft/autogen) — A programming framework for agentic AI  `Python` ⭐ 59,580
