...
- 🌿 **Created branch** `docs/536-http-status-checks-seo-agent` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `30 May 2026`
- 🌿 **Created branch** `fix/20260530-improve-repo-topics-task-copy` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `30 May 2026`
- 🌿 **Created branch** `fix/20260530-improve-stack-focus-task-wording` in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `30 May 2026`

<sub>Last updated: 30 May 2026 at 16:25 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**dotnet/skills**](https://github.com/dotnet/skills) — Repository for skills to assist AI coding agents with .NET and C#  `C#` ⭐ 3,190
- [**AzuraCast/AzuraCast**](https://github.com/AzuraCast/AzuraCast) — A self-hosted web radio management suite, including turnkey installer tools for   `PHP` ⭐ 3,880
