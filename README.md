...
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Narrow the search index to useful visitor destinations_ `5 Sep 2026`
- 🔀 **Opened PR** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — __ `5 Sep 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Fix mojibake in Donovan’s “Greatest Hits… and More” release title_ `5 Sep 2026`
- 🐛 **Opened issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Fix mojibake in Donovan’s “Greatest Hits… and More” release title_ `5 Sep 2026`
...
- 🌿 **Created branch** `fix/src/modal-focus-management` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `4 Sep 2026`
- 🌿 **Created branch** `fix/src/normalise-search-separators` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `4 Sep 2026`
- 🌿 **Created branch** `fix/src/add-antics-artwork` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `3 Sep 2026`

<sub>Last updated: 5 September 2026 at 11:08 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**JetBrains/go-modern-guidelines**](https://github.com/JetBrains/go-modern-guidelines) — Help AI coding agents write modern Go  `Go` ⭐ 3,208
...
- [**backstage/backstage**](https://github.com/backstage/backstage) — Backstage is an open framework for building developer portals  `TypeScript` ⭐ 34,333
- [**block/buzz**](https://github.com/block/buzz) — A hive mind communication platform  `Rust` ⭐ 32,172
