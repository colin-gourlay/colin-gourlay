...
<sub>Last updated: 8 April 2026 at 08:30 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**ollama/ollama**](https://github.com/ollama/ollama) — Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemm  `Go` ⭐ 168,110
...
- [**abhigyanpatwari/GitNexus**](https://github.com/abhigyanpatwari/GitNexus) — GitNexus: The Zero-Server Code Intelligence Engine -       GitNexus is a client-  `TypeScript` ⭐ 24,890
- [**google-ai-edge/gallery**](https://github.com/google-ai-edge/gallery) — A gallery that showcases on-device ML/GenAI use cases and allows people to try a  `Kotlin` ⭐ 19,091
- [**aaif-goose/goose**](https://github.com/aaif-goose/goose) — an open source, extensible AI agent that goes beyond code suggestions - install,  `Rust` ⭐ 39,286
- [**google-ai-edge/LiteRT-LM**](https://github.com/google-ai-edge/LiteRT-LM)  `C++` ⭐ 2,730
