...
- 🐛 **Opened issue** in [`colin-gourlay/qwerty`](https://github.com/colin-gourlay/qwerty) — _Replace the stock header logo with the Sundown Radio logo_ `3 Sep 2026`
- 🔀 **Opened PR** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — __ `3 Sep 2026`
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Add missing artwork to the Antics Release page_ `3 Sep 2026`
- 🔀 **Opened PR** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — __ `3 Sep 2026`
- 🔀 **Closed PR** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — __ `3 Sep 2026`

<sub>Last updated: 3 September 2026 at 10:12 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**JetBrains/go-modern-guidelines**](https://github.com/JetBrains/go-modern-guidelines) — Help AI coding agents write modern Go  `Go` ⭐ 3,071
...
- [**block/buzz**](https://github.com/block/buzz) — A hive mind communication platform  `Rust` ⭐ 32,027
