...
<sub>Last updated: 18 April 2026 at 11:15 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**BasedHardware/omi**](https://github.com/BasedHardware/omi) — AI that sees your screen, listens to your conversations and tells you what to do  `Dart` ⭐ 10,083
- [**EvoMap/evolver**](https://github.com/EvoMap/evolver) — The GEP-Powered Self-Evolution Engine for AI Agents. Genome Evolution Protocol.   `JavaScript` ⭐ 4,699
- [**openai/openai-agents-python**](https://github.com/openai/openai-agents-python) — A lightweight, powerful framework for multi-agent workflows  `Python` ⭐ 22,022
- [**mvanhorn/last30days-skill**](https://github.com/mvanhorn/last30days-skill) — AI agent skill that researches any topic across Reddit, X, YouTube, HN, Polymark  `Python` ⭐ 22,522
- [**addyosmani/agent-skills**](https://github.com/addyosmani/agent-skills) — Production-grade engineering skills for AI coding agents.  `Shell` ⭐ 17,210
- [**lsdefine/GenericAgent**](https://github.com/lsdefine/GenericAgent) — Self-evolving agent: grows skill tree from 3.3K-line seed, achieving full system  `Python` ⭐ 4,012
