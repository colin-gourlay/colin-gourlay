...
- 🐛 **Closed issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Remove duration metadata from the Propaganda Track page_ `31 Aug 2026`
- 🐛 **Opened issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Limit Homepage Recent Shows to the Three Most Recent Broadcasts_ `31 Aug 2026`
- 🌿 **Created branch** `fix/src/remove-propaganda-track-duration` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `31 Aug 2026`
- 🔀 **Opened PR** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — __ `31 Aug 2026`
- 🌿 **Created branch** `fix/897-roachford-edition-and-track` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `28 Aug 2026`
- 🐛 **Opened issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Add Track page and links for IST IST — “Fat Cats Drown in Milk”_ `30 Aug 2026`
- 🐛 **Opened issue** in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) — _Remove duration metadata from the Propaganda Track page_ `30 Aug 2026`
- 🔀 **Opened PR** in [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) — __ `30 Aug 2026`
- 🔨 **Pushed** to [`colin-gourlay/todoist-playbook`](https://github.com/colin-gourlay/todoist-playbook) `28 Aug 2026`
- 🌿 **Created branch** `fix/src/strengthen-track-show-discovery` in [`colin-gourlay/sundown-sessions`](https://github.com/colin-gourlay/sundown-sessions) `28 Aug 2026`

<sub>Last updated: 31 August 2026 at 07:19 UTC</sub>
<!-- ACTIVITY_END -->
...
- [**BrighterCommand/Fences**](https://github.com/BrighterCommand/Fences) — Fences is a .NET resilience and transient-fault-handling library that allows dev  `C#` ⭐ 48
- [**JetBrains/go-modern-guidelines**](https://github.com/JetBrains/go-modern-guidelines) — Help AI coding agents write modern Go  `Go` ⭐ 2,993
...
- [**backstage/backstage**](https://github.com/backstage/backstage) — Backstage is an open framework for building developer portals  `TypeScript` ⭐ 34,279
- [**block/buzz**](https://github.com/block/buzz) — A hive mind communication platform  `Rust` ⭐ 31,583
